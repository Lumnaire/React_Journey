...
function App() {
  ...
  style = {{backgroundImage: `url(https://static.vecteezy.com/system/resources/previews/001/925/656/non_2x/business-graph-chart-of-stock-market-investment-on-blue-background-vector.jpg)`}}
  >
    <div className='w-full'>
      <div className='w-full max-w-md mx-auto border border-gray-60 rounded-lg p-5 backdrop-blue-sm bg-white/30'>
        <form onSubmit={(e) => {
          ...
          <div className='relative wi-full h-0.5'>
            <button
